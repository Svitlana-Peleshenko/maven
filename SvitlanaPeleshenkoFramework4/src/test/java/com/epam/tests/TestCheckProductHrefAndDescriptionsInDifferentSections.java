...
public class TestCheckProductHrefAndDescriptionsInDifferentSections extends BaseTest {
	...
	public void CheckHref(String productForSort, Double counts)
		...
		CheckProductHrefAndDescriptionsInDifferentSectionsHelper.CheckHref(catalogComponent,navigateMenuComponent, header, priceList, counts);
	...
	public void CheckDescriptions(String productForSort, Double counts)
		...
		openUrl();
		GoToPageHelper.GoToPages(productForSort, mainMenuComponent);
		CheckProductHrefAndDescriptionsInDifferentSectionsHelper.CheckDescriptions(catalogComponent, information, menu, counts);
