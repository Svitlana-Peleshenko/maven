...
public class TestCompareSorting extends BaseTest {
	...
	public void ComparePrices(String productForSort)
		...
		CompareHelper.ComparePrice(navigateMenuComponent, catalogComponent);
	}
	...
	public void CompareTitles(String productForSort)
		...
		openUrl();
		GoToPageHelper.GoToPages(productForSort, mainMenuComponent);
		CompareHelper.CompareTitle(navigateMenuComponent, catalogComponent);
	}
