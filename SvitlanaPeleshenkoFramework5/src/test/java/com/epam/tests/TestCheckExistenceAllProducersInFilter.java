...
import com.epam.helpers.CheckExistenceAllProducersInFilterHelper;
import com.epam.helpers.GoToPageHelper;
import com.epam.provider.TestDataProvider;



public class TestCheckExistenceAllProducersInFilter extends BaseTest {
	...
	public void CheckProducerFilter (String productForSort) throws InterruptedException, IOException, SkipPageException  {
		openUrl();
		GoToPageHelper.GoToPages(productForSort, mainMenuComponent);
		CheckExistenceAllProducersInFilterHelper.CheckProducerFilter( navigateMenuComponent,catalogComponent,filterComponent, driver);
